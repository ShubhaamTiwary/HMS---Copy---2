    ...
    <div className='flex flex-col w-full  bg-defaultBg'>
        ...
        <div className='flex justify-center mt-10 mb-64'>
            ...
            <div className='w-full mt-3 ml-6 flex justify-start'>
                <a href='https://hms-copy-2-deploy1.vercel.app/hostel-Registration'>
                ...
                <a href='https://hms-copy-2-deploy1.vercel.app/student-Registration'>
                ...
                <a href='https://hms-copy-2-deploy1.vercel.app/tower-Registration'>
                ...
                <a href='https://hms-copy-2-deploy1.vercel.app/wing-Registration'>
                <button className='bg-defaultBg w-32 h-8 border-2 border-slate-950 rounded-l-full rounded-r-full ml-10'>
                    <p className='font-popins text-normal'>+ Add Wing</p>
                </button>
                </a>

                <a href='https://hms-copy-2-deploy1.vercel.app/room-Registration'>
                <button className='bg-defaultBg w-32 h-8 border-2 border-slate-950 rounded-l-full rounded-r-full ml-10'>
            ...
            <div className='w-full mt-3 ml-6 flex justify-start'>
                <a href='https://hms-copy-2-deploy1.vercel.app/hostel-FormReview'>
