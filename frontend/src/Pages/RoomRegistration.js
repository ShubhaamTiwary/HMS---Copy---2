...
const TowerRegistartion = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://hms-hostel-management-done.onrender.com/hostel/tower/wing', formData)
        .then((response) => {
    ...
    const hostel_name_and_id_fetch = async () => {
      try{
        const response = await fetch("https://hms-hostel-management-done.onrender.com/gethostel_id/where/status_active",{
          method:"GET",
